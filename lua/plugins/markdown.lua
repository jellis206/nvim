...
return {
    {
        -- Fork of iamcco/markdown-preview.nvim with the /page/<bufnr> reload-URL
        -- fix baked in; syncs upstream biweekly via GitHub Actions.
        "jellis206/markdown-preview.nvim",
